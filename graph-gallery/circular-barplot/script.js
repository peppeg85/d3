//from https://d3-graph-gallery.com/graph/circular_barplot_label.html
...
d3.csv("https://raw.githubusercontent.com/holtzy/data_to_viz/master/Example_dataset/7_OneCatOneNum.csv").then(function (data) {
    ...
    const y = d3.scaleRadial()
        .domain([0, d3.max(data, d => parseInt(d.Value))]) // Domain of Y is from 0 to the max seen in the data
        .range([innerRadius, outerRadius])   // Domain will be define later.
    console.log(d3.max(data, d => parseInt(d.Value)))
    // Add the bars
    svg.append("g")
        .selectAll("path")
        .data(data)
